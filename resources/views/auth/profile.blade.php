...
<div class="container-fluid mt-3 row card p-3 bg-light">
  ...
  <?php } ?>
    ...
    <form id="ajaxForm" action="<?= route("profile") ?>" method="POST" class="col-md-7 offset-md-3" enctype="multipart/form-data">
    ...
    <div class="mb-3">
        ...
        <input type="password" class="form-control" id="password" placeholder="Enter new password" name="password" value="<?= old('password') ?>">
